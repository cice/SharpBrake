...
namespace SharpBrakeCore.Serialization
{
    /// <summary>
    ...
    public class AirbrakeTraceLine
    {
        ...
        public AirbrakeTraceLine(string file, int lineNumber, string method)
        {
            if (file == null)
        ...
        public static AirbrakeTraceLine Empty
        {
            get { return new AirbrakeTraceLine("none", 0, null); }
        }
